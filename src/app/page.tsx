        ...
        <div className="w-full px-5 py-6 space-y-10">
          ...
          <section className="space-y-3">
            <div className="flex flex-col gap-1 mb-1">
              <h2 className="text-xl font-bold text-green-900">오늘의 베스트 딜</h2>
          ...
          <section className="space-y-3">
            <div className="flex flex-col gap-1 mb-1">
              <h2 className="text-xl font-bold text-green-900">카테고리별 마트 가격 비교</h2>
          ...
          <section className="space-y-3">
            <div className="flex flex-col gap-1 mb-1">
              <h2 className="text-xl font-bold text-green-900">{currentMonth}월 제철 과일 장바구니</h2>
